	...
	if in.DiskLocations != nil {
		...
		*out = make(map[string]*v1beta2.DiskLocation, len(*in))
		for key, val := range *in {
			...
			if err := Convert_impl_DiskLocation_To_v1beta2_DiskLocation(val, newVal); err != nil {
				return err
			}
...
func Convert_v1beta2_ListDiskLocationsResponse_To_impl_ListDiskLocationsResponse(in *v1beta2.ListDiskLocationsResponse, out *impl.ListDiskLocationsResponse) error {
...
func Convert_impl_ListDiskIDsResponse_To_v1beta2_ListDiskIDsResponse(in *impl.ListDiskIDsResponse, out *v1beta2.ListDiskIDsResponse) error {
...
func Convert_v1beta2_ListDiskIDsResponse_To_impl_ListDiskIDsResponse(in *v1beta2.ListDiskIDsResponse, out *impl.ListDiskIDsResponse) error {
	// there's no need to implement this function because it's never used (we only convert an impl response to a client response)
	// however we need to override it so that the generator doesn't generate the wrong implementation
	// see https://kubernetes.slack.com/archives/CN5JCCW31/p1621979489011400
	return nil
...
func Convert_v1beta2_PartitionDiskRequest_To_impl_PartitionDiskRequest(in *v1beta2.PartitionDiskRequest, out *impl.PartitionDiskRequest) error {
