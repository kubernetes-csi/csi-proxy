...
func autoConvert_v1_LsdirRequest_To_impl_LsdirRequest(in *v1.LsdirRequest, out *impl.LsdirRequest) error {
	out.Path = in.Path
	return nil
}

// Convert_v1_LsdirRequest_To_impl_LsdirRequest is an autogenerated conversion function.
func Convert_v1_LsdirRequest_To_impl_LsdirRequest(in *v1.LsdirRequest, out *impl.LsdirRequest) error {
	return autoConvert_v1_LsdirRequest_To_impl_LsdirRequest(in, out)
}

func autoConvert_impl_LsdirRequest_To_v1_LsdirRequest(in *impl.LsdirRequest, out *v1.LsdirRequest) error {
	out.Path = in.Path
	return nil
}

// Convert_impl_LsdirRequest_To_v1_LsdirRequest is an autogenerated conversion function.
func Convert_impl_LsdirRequest_To_v1_LsdirRequest(in *impl.LsdirRequest, out *v1.LsdirRequest) error {
	return autoConvert_impl_LsdirRequest_To_v1_LsdirRequest(in, out)
}

func autoConvert_v1_LsdirResponse_To_impl_LsdirResponse(in *v1.LsdirResponse, out *impl.LsdirResponse) error {
	out.Files = *(*[]string)(unsafe.Pointer(&in.Files))
	return nil
}

// Convert_v1_LsdirResponse_To_impl_LsdirResponse is an autogenerated conversion function.
func Convert_v1_LsdirResponse_To_impl_LsdirResponse(in *v1.LsdirResponse, out *impl.LsdirResponse) error {
	return autoConvert_v1_LsdirResponse_To_impl_LsdirResponse(in, out)
}

func autoConvert_impl_LsdirResponse_To_v1_LsdirResponse(in *impl.LsdirResponse, out *v1.LsdirResponse) error {
	out.Files = *(*[]string)(unsafe.Pointer(&in.Files))
	return nil
}

// Convert_impl_LsdirResponse_To_v1_LsdirResponse is an autogenerated conversion function.
func Convert_impl_LsdirResponse_To_v1_LsdirResponse(in *impl.LsdirResponse, out *v1.LsdirResponse) error {
	return autoConvert_impl_LsdirResponse_To_v1_LsdirResponse(in, out)
}
