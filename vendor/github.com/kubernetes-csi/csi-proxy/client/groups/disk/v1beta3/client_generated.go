...
type Client struct {
	client     v1beta3.DiskClient
	connection *grpc.ClientConn
}

// NewClient returns a client to make calls to the disk API group version v1beta3.
...
func NewClientWithPipePath(pipePath string) (*Client, error) {
	...
	client := v1beta3.NewDiskClient(connection)
	return &Client{
		client:     client,
...
func (w *Client) ListDiskLocations(context context.Context, request *v1beta3.ListDiskLocationsRequest, opts ...grpc.CallOption) (*v1beta3.ListDiskLocationsResponse, error) {
	return w.client.ListDiskLocations(context, request, opts...)
}

func (w *Client) PartitionDisk(context context.Context, request *v1beta3.PartitionDiskRequest, opts ...grpc.CallOption) (*v1beta3.PartitionDiskResponse, error) {
	return w.client.PartitionDisk(context, request, opts...)
}

func (w *Client) Rescan(context context.Context, request *v1beta3.RescanRequest, opts ...grpc.CallOption) (*v1beta3.RescanResponse, error) {
