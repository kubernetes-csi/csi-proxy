...
func (w *Client) DismountVolume(context context.Context, request *v1.DismountVolumeRequest, opts ...grpc.CallOption) (*v1.DismountVolumeResponse, error) {
...
func (w *Client) GetVolumeDiskNumber(context context.Context, request *v1.VolumeDiskNumberRequest, opts ...grpc.CallOption) (*v1.VolumeDiskNumberResponse, error) {
	return w.client.GetVolumeDiskNumber(context, request, opts...)
}

func (w *Client) GetVolumeIDFromMount(context context.Context, request *v1.VolumeIDFromMountRequest, opts ...grpc.CallOption) (*v1.VolumeIDFromMountResponse, error) {
...
func (w *Client) VolumeStats(context context.Context, request *v1.VolumeStatsRequest, opts ...grpc.CallOption) (*v1.VolumeStatsResponse, error) {
