...
type Client struct {
	client     v1beta2.SmbClient
	connection *grpc.ClientConn
}

// NewClient returns a client to make calls to the smb API group version v1beta2.
...
func NewClientWithPipePath(pipePath string) (*Client, error) {
	...
	client := v1beta2.NewSmbClient(connection)
	return &Client{
		client:     client,
...
var _ v1beta2.SmbClient = &Client{}

func (w *Client) NewSmbGlobalMapping(context context.Context, request *v1beta2.NewSmbGlobalMappingRequest, opts ...grpc.CallOption) (*v1beta2.NewSmbGlobalMappingResponse, error) {
	return w.client.NewSmbGlobalMapping(context, request, opts...)
}

func (w *Client) RemoveSmbGlobalMapping(context context.Context, request *v1beta2.RemoveSmbGlobalMappingRequest, opts ...grpc.CallOption) (*v1beta2.RemoveSmbGlobalMappingResponse, error) {
