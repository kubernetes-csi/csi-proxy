...
type Client struct {
	client     v1beta3.VolumeClient
	connection *grpc.ClientConn
}

// NewClient returns a client to make calls to the volume API group version v1beta3.
...
func (w *Client) GetVolumeStats(context context.Context, request *v1beta3.GetVolumeStatsRequest, opts ...grpc.CallOption) (*v1beta3.GetVolumeStatsResponse, error) {
	return w.client.GetVolumeStats(context, request, opts...)
}

func (w *Client) IsVolumeFormatted(context context.Context, request *v1beta3.IsVolumeFormattedRequest, opts ...grpc.CallOption) (*v1beta3.IsVolumeFormattedResponse, error) {
	return w.client.IsVolumeFormatted(context, request, opts...)
}

func (w *Client) ListVolumesOnDisk(context context.Context, request *v1beta3.ListVolumesOnDiskRequest, opts ...grpc.CallOption) (*v1beta3.ListVolumesOnDiskResponse, error) {
	return w.client.ListVolumesOnDisk(context, request, opts...)
}

func (w *Client) MountVolume(context context.Context, request *v1beta3.MountVolumeRequest, opts ...grpc.CallOption) (*v1beta3.MountVolumeResponse, error) {
	return w.client.MountVolume(context, request, opts...)
}

func (w *Client) ResizeVolume(context context.Context, request *v1beta3.ResizeVolumeRequest, opts ...grpc.CallOption) (*v1beta3.ResizeVolumeResponse, error) {
