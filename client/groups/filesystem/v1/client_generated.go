...
func (w *Client) IsMountPoint(context context.Context, request *v1.IsMountPointRequest, opts ...grpc.CallOption) (*v1.IsMountPointResponse, error) {
	return w.client.IsMountPoint(context, request, opts...)
}

func (w *Client) LinkPath(context context.Context, request *v1.LinkPathRequest, opts ...grpc.CallOption) (*v1.LinkPathResponse, error) {
