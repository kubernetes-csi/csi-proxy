...
func (s *versionedAPI) ComputeDouble(context context.Context, versionedRequest *v1alpha1.ComputeDoubleRequest) (*v1alpha1.ComputeDoubleResponse, error) {
	...
	if err := Convert_v1alpha1_ComputeDoubleRequest_To_impl_ComputeDoubleRequest(versionedRequest, request); err != nil {
		return nil, err
	}
	...
	if err := Convert_impl_ComputeDoubleResponse_To_v1alpha1_ComputeDoubleResponse(response, versionedResponse); err != nil {
		return nil, err
	}
