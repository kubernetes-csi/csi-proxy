...
func v1beta1VolumeTests(t *testing.T) {
	...
	isVolumeFormattedRequest := &v1beta1.IsVolumeFormattedRequest{
		VolumeId: volumeID,
	}
	isVolumeFormattedResponse, err := v1beta1Client.IsVolumeFormatted(context.TODO(), isVolumeFormattedRequest)
	if err != nil {
