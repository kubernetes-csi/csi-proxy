...
// see https://docs.microsoft.com/en-us/windows/win32/api/iscsidsc/ne-iscsidsc-iscsi_auth_types
...
type AddIScsiConnectionRequest struct {
	SessionId           *IscsiID     `protobuf:"bytes,1,opt,name=session_id,json=sessionId,proto3" json:"session_id,omitempty"`
	InitiatorPortNumber uint32       `protobuf:"varint,2,opt,name=initiator_port_number,json=initiatorPortNumber,proto3" json:"initiator_port_number,omitempty"`
	TargetPortal        *IscsiPortal `protobuf:"bytes,3,opt,name=target_portal,json=targetPortal,proto3" json:"target_portal,omitempty"`
	// see the "SecurityFlags" section of https://docs.microsoft.com/en-us/windows/desktop/api/iscsidsc/nf-iscsidsc-addiscsisendtargetportalw
	SecurityFlags        uint64             `protobuf:"varint,4,opt,name=security_flags,json=securityFlags,proto3" json:"security_flags,omitempty"`
	LoginOptions         *IscsiLoginOptions `protobuf:"bytes,5,opt,name=login_options,json=loginOptions,proto3" json:"login_options,omitempty"`
...
func (m *AddIScsiConnectionRequest) Reset()         { *m = AddIScsiConnectionRequest{} }
func (m *AddIScsiConnectionRequest) String() string { return proto.CompactTextString(m) }
func (*AddIScsiConnectionRequest) ProtoMessage()    {}
func (*AddIScsiConnectionRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_954acfae42d1ccbb, []int{16}
}

func (m *AddIScsiConnectionRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_AddIScsiConnectionRequest.Unmarshal(m, b)
}
func (m *AddIScsiConnectionRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_AddIScsiConnectionRequest.Marshal(b, m, deterministic)
}
func (m *AddIScsiConnectionRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AddIScsiConnectionRequest.Merge(m, src)
}
func (m *AddIScsiConnectionRequest) XXX_Size() int {
	return xxx_messageInfo_AddIScsiConnectionRequest.Size(m)
}
func (m *AddIScsiConnectionRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_AddIScsiConnectionRequest.DiscardUnknown(m)
}

var xxx_messageInfo_AddIScsiConnectionRequest proto.InternalMessageInfo

func (m *AddIScsiConnectionRequest) GetSessionId() *IscsiID {
	if m != nil {
		return m.SessionId
	}
	return nil
...
func (m *AddIScsiConnectionRequest) GetInitiatorPortNumber() uint32 {
	if m != nil {
		return m.InitiatorPortNumber
	}
	return 0
...
func (m *AddIScsiConnectionRequest) GetTargetPortal() *IscsiPortal {
	if m != nil {
		return m.TargetPortal
	}
	return nil
...
func (m *AddIScsiConnectionRequest) GetSecurityFlags() uint64 {
	if m != nil {
		return m.SecurityFlags
	}
	return 0
...
func (m *AddIScsiConnectionRequest) GetLoginOptions() *IscsiLoginOptions {
	if m != nil {
		return m.LoginOptions
	}
	return nil
...
func (m *AddIScsiConnectionRequest) GetKey() string {
	if m != nil {
		return m.Key
	}
	return ""
...
type AddIScsiConnectionResponse struct {
	Success bool `protobuf:"varint,1,opt,name=success,proto3" json:"success,omitempty"`
	// Types that are valid to be assigned to Error:
	//	*AddIScsiConnectionResponse_WindowsApiError
	//	*AddIScsiConnectionResponse_ErrorMessage
	Error                isAddIScsiConnectionResponse_Error `protobuf_oneof:"error"`
	ConnectionId         *IscsiID                           `protobuf:"bytes,4,opt,name=connection_id,json=connectionId,proto3" json:"connection_id,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                           `json:"-"`
	XXX_unrecognized     []byte                             `json:"-"`
	XXX_sizecache        int32                              `json:"-"`
}

func (m *AddIScsiConnectionResponse) Reset()         { *m = AddIScsiConnectionResponse{} }
func (m *AddIScsiConnectionResponse) String() string { return proto.CompactTextString(m) }
func (*AddIScsiConnectionResponse) ProtoMessage()    {}
func (*AddIScsiConnectionResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_954acfae42d1ccbb, []int{17}
}

func (m *AddIScsiConnectionResponse) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_AddIScsiConnectionResponse.Unmarshal(m, b)
}
func (m *AddIScsiConnectionResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_AddIScsiConnectionResponse.Marshal(b, m, deterministic)
}
func (m *AddIScsiConnectionResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AddIScsiConnectionResponse.Merge(m, src)
}
func (m *AddIScsiConnectionResponse) XXX_Size() int {
	return xxx_messageInfo_AddIScsiConnectionResponse.Size(m)
}
func (m *AddIScsiConnectionResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_AddIScsiConnectionResponse.DiscardUnknown(m)
}

var xxx_messageInfo_AddIScsiConnectionResponse proto.InternalMessageInfo

func (m *AddIScsiConnectionResponse) GetSuccess() bool {
	if m != nil {
		return m.Success
	}
	return false
...
type isAddIScsiConnectionResponse_Error interface {
	isAddIScsiConnectionResponse_Error()
}

type AddIScsiConnectionResponse_WindowsApiError struct {
	WindowsApiError *WindowsApiError `protobuf:"bytes,2,opt,name=windows_api_error,json=windowsApiError,proto3,oneof"`
}

type AddIScsiConnectionResponse_ErrorMessage struct {
	ErrorMessage string `protobuf:"bytes,3,opt,name=error_message,json=errorMessage,proto3,oneof"`
}

func (*AddIScsiConnectionResponse_WindowsApiError) isAddIScsiConnectionResponse_Error() {}

func (*AddIScsiConnectionResponse_ErrorMessage) isAddIScsiConnectionResponse_Error() {}

func (m *AddIScsiConnectionResponse) GetError() isAddIScsiConnectionResponse_Error {
	if m != nil {
		return m.Error
	}
	return nil
...
func (m *AddIScsiConnectionResponse) GetWindowsApiError() *WindowsApiError {
	if x, ok := m.GetError().(*AddIScsiConnectionResponse_WindowsApiError); ok {
		return x.WindowsApiError
	}
	return nil
}

func (m *AddIScsiConnectionResponse) GetErrorMessage() string {
	if x, ok := m.GetError().(*AddIScsiConnectionResponse_ErrorMessage); ok {
		return x.ErrorMessage
	}
	return ""
}

func (m *AddIScsiConnectionResponse) GetConnectionId() *IscsiID {
	if m != nil {
		return m.ConnectionId
	}
	return nil
...
// XXX_OneofWrappers is for the internal use of the proto package.
func (*AddIScsiConnectionResponse) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*AddIScsiConnectionResponse_WindowsApiError)(nil),
		(*AddIScsiConnectionResponse_ErrorMessage)(nil),
	}
}
...
func init() {
	...
	proto.RegisterType((*AddIScsiConnectionRequest)(nil), "api.AddIScsiConnectionRequest")
	proto.RegisterType((*AddIScsiConnectionResponse)(nil), "api.AddIScsiConnectionResponse")
...
var fileDescriptor_954acfae42d1ccbb = []byte{
	...
	,
}
...
type IscsiCSIProxyServiceClient interface {
	...
	AddIScsiConnection(ctx context.Context, in *AddIScsiConnectionRequest, opts ...grpc.CallOption) (*AddIScsiConnectionResponse, error)
...
func (c *iscsiCSIProxyServiceClient) AddIScsiConnection(ctx context.Context, in *AddIScsiConnectionRequest, opts ...grpc.CallOption) (*AddIScsiConnectionResponse, error) {
	out := new(AddIScsiConnectionResponse)
	err := c.cc.Invoke(ctx, "/api.IscsiCSIProxyService/AddIScsiConnection", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type IscsiCSIProxyServiceServer interface {
	...
	// Only the session ID and the targetPortal are required.
	// see https://docs.microsoft.com/en-us/windows/desktop/api/iscsidsc/nf-iscsidsc-addiscsiconnectionw
	AddIScsiConnection(context.Context, *AddIScsiConnectionRequest) (*AddIScsiConnectionResponse, error)
	// LogoutIScsiTarget closes the specified login session.
	// see https://docs.microsoft.com/en-us/windows/desktop/api/iscsidsc/nf-iscsidsc-logoutiscsitarget
...
func (*UnimplementedIscsiCSIProxyServiceServer) AddIScsiConnection(ctx context.Context, req *AddIScsiConnectionRequest) (*AddIScsiConnectionResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AddIScsiConnection not implemented")
}
...
func _IscsiCSIProxyService_AddIScsiConnection_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AddIScsiConnectionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(IscsiCSIProxyServiceServer).AddIScsiConnection(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.IscsiCSIProxyService/AddIScsiConnection",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IscsiCSIProxyServiceServer).AddIScsiConnection(ctx, req.(*AddIScsiConnectionRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _IscsiCSIProxyService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "AddIScsiConnection",
			Handler:    _IscsiCSIProxyService_AddIScsiConnection_Handler,
		},
		{
