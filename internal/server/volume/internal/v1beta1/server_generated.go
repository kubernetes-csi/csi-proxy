...
func (s *versionedAPI) DismountVolume(context context.Context, versionedRequest *v1beta1.DismountVolumeRequest) (*v1beta1.DismountVolumeResponse, error) {
	...
	if err := Convert_v1beta1_DismountVolumeRequest_To_internal_DismountVolumeRequest(versionedRequest, request); err != nil {
		return nil, err
	}
	...
	if err := Convert_internal_DismountVolumeResponse_To_v1beta1_DismountVolumeResponse(response, versionedResponse); err != nil {
		return nil, err
	}
...
func (s *versionedAPI) FormatVolume(context context.Context, versionedRequest *v1beta1.FormatVolumeRequest) (*v1beta1.FormatVolumeResponse, error) {
	...
	if err := Convert_v1beta1_FormatVolumeRequest_To_internal_FormatVolumeRequest(versionedRequest, request); err != nil {
		return nil, err
	}
	...
	if err := Convert_internal_FormatVolumeResponse_To_v1beta1_FormatVolumeResponse(response, versionedResponse); err != nil {
		return nil, err
	}
...
func (s *versionedAPI) IsVolumeFormatted(context context.Context, versionedRequest *v1beta1.IsVolumeFormattedRequest) (*v1beta1.IsVolumeFormattedResponse, error) {
	...
	if err := Convert_internal_IsVolumeFormattedResponse_To_v1beta1_IsVolumeFormattedResponse(response, versionedResponse); err != nil {
		return nil, err
	}
...
func (s *versionedAPI) ListVolumesOnDisk(context context.Context, versionedRequest *v1beta1.ListVolumesOnDiskRequest) (*v1beta1.ListVolumesOnDiskResponse, error) {
	...
	if err := Convert_v1beta1_ListVolumesOnDiskRequest_To_internal_ListVolumesOnDiskRequest(versionedRequest, request); err != nil {
		return nil, err
	}
	...
	if err := Convert_internal_ListVolumesOnDiskResponse_To_v1beta1_ListVolumesOnDiskResponse(response, versionedResponse); err != nil {
		return nil, err
	}
...
func (s *versionedAPI) MountVolume(context context.Context, versionedRequest *v1beta1.MountVolumeRequest) (*v1beta1.MountVolumeResponse, error) {
	...
	if err := Convert_v1beta1_MountVolumeRequest_To_internal_MountVolumeRequest(versionedRequest, request); err != nil {
		return nil, err
	}
	...
	if err := Convert_internal_MountVolumeResponse_To_v1beta1_MountVolumeResponse(response, versionedResponse); err != nil {
		return nil, err
	}
...
func (s *versionedAPI) ResizeVolume(context context.Context, versionedRequest *v1beta1.ResizeVolumeRequest) (*v1beta1.ResizeVolumeResponse, error) {
	...
	if err := Convert_v1beta1_ResizeVolumeRequest_To_internal_ResizeVolumeRequest(versionedRequest, request); err != nil {
		return nil, err
	}
	...
	if err := Convert_internal_ResizeVolumeResponse_To_v1beta1_ResizeVolumeResponse(response, versionedResponse); err != nil {
		return nil, err
	}
...
func (s *versionedAPI) VolumeStats(context context.Context, versionedRequest *v1beta1.VolumeStatsRequest) (*v1beta1.VolumeStatsResponse, error) {
	...
	if err := Convert_v1beta1_VolumeStatsRequest_To_internal_VolumeStatsRequest(versionedRequest, request); err != nil {
		return nil, err
	}
	...
	if err := Convert_internal_VolumeStatsResponse_To_v1beta1_VolumeStatsResponse(response, versionedResponse); err != nil {
		return nil, err
	}
