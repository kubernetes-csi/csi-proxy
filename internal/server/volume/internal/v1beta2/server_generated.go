...
func (s *versionedAPI) WriteVolumeCache(context context.Context, versionedRequest *v1beta2.WriteVolumeCacheRequest) (*v1beta2.WriteVolumeCacheResponse, error) {
	...
	if err := Convert_v1beta2_WriteVolumeCacheRequest_To_internal_WriteVolumeCacheRequest(versionedRequest, request); err != nil {
		return nil, err
	}
	...
	if err := Convert_internal_WriteVolumeCacheResponse_To_v1beta2_WriteVolumeCacheResponse(response, versionedResponse); err != nil {
		return nil, err
	}
